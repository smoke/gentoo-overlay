...
pkg_nofetch() {
	...
	einfo
	einfo "  http://www.oracle.com/technetwork/java/javase/downloads/jdk10-downloads-4416644.html"
	einfo
	...
	einfo
	einfo "  http://www.oracle.com/technetwork/java/javase/downloads/java-archive-javase10-4425482.html"
	einfo
}
...
src_install() {
	...
	"${ddest}/bin/java" -Duser.home="${T}" -server -Xshare:dump || die
